...
/**
 * Producer Login Page - Redirects to Central Auth
 * 
 * This page redirects to the central auth server for producer login.
 * After successful authentication, users are redirected back to /producer.
 * 
 * Query Parameters:
