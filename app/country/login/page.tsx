...
/**
 * Country Login Page - Redirects to Central Auth
 * 
 * This page redirects to the central auth server for country panel login.
 * After successful authentication, users are redirected back to /country.
 * 
 * Query Parameters:
 ...
 */
export default function CountryLoginPage() {
  return (
    <AuthRedirectPage
      panelName="country"
      action="login"
