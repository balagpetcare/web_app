...
/**
 * Owner Login Page - Redirects to Central Auth
 * 
 * This page redirects to the central auth server for login.
 * After successful authentication, users are redirected back to /owner.
 * 
 * Query Parameters:
