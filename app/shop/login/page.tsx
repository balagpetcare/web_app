...
/**
 * Shop Login Page - Redirects to Central Auth
 * 
 * This page redirects to the central auth server for shop login.
 * After successful authentication, users are redirected back to /shop.
 * 
 * Query Parameters:
